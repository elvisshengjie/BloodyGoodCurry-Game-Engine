/*********************************************************************************************
 ...
 \brief     Declares the EnemyAttackComponent, which manages timed enemy attack behavior,
            damage output, and hitbox activation. The component controls attack cooldowns,
            spawns temporary hitboxes, and integrates with TransformComponent for position.
 \details
            Responsibilities:
            - Track attack cooldown via attack_timer and attack_speed.
            - Activate a HitBoxComponent when an attack is triggered.
            - Handle automatic hitbox deactivation after a set duration.
            - Support serialization for prefab and level data.
            - Provide deep-copy functionality via Clone() for prefab instancing.
 \copyright
